...
def drawsafelines(image_np,Line_Perc1,Line_Perc2):
    ...
    print(Line_Position2,image_np.shape[1],"ooop")
    ...
    cv2.line(img=image_np, pt1=(0, 400), pt2=(400, 400), color=(255, 0, 0), thickness=2, lineType=8, shift=0)
